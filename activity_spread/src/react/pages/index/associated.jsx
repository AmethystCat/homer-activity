...
class Associated extends React.Component {
    ...
    render() {
        ...
        let dom_isManager_isZB = (
            <ul>
                <li><Link to="/api/seller/list"><span className="item-name">人员</span><span className="quantity-people">20人<i className="sprite sprite-icon_arrow_right"></i></span></Link></li>
        ...
        let dom_notManager_notZB = (
            <ul>
                ...
                <li><Link to="/api/seller/add-order"><span className="item-name">添加订单</span><span className="quantity-lock"><i className="sprite sprite-icon_arrow_right"></i></span></Link></li>
